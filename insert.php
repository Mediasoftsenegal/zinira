...
//Client
    ...
    if(isset($_POST['bt_modif_client'])){
      ...
      $exec = $bdd->prepare($sql)->execute(array(":prenom_nom"=>$_POST['prenom_nom'], ":genre"=>$_POST['genre'], ":telephone"=>$_POST['telephone'], ":adresse"=>$_POST['adresse'], ":id_client"=>$_POST['id_client']));
...
//Mesure
    ...
    if(isset($_POST['bt_modif_mesure'])){
      ...
      $sql = "UPDATE `zen_mesure` SET `longueur`=:longueur, `longueurgrandboubou`=:longueurgrandboubou, `epaule`=:epaule, `cou`=:cou, `manche`=:manche, `taille`=:taille, `taillemanche`=:taillemanche, `poignet`=:poignet, `longueurpantalon`=:longueurpantalon, `taillecou`=:taillecou, `tourfess`=:tourfess, `cuisse`=:cuisse, `bas`=:bas, `poitrine`=:poitrine, `hanche`=:hanche, `pince`=:pince, `blouse`=:blouse, `longueurjupe`=:longueurjupe, `longueurrobe`=:longueurrobe WHERE `zen_mesure`.`id_mesure`=:id_mesure";
      $exec = $bdd->prepare($sql)->execute(array(":longueur"=>$_POST['longueur'], ":longueurgrandboubou"=>$_POST['longueurgrandboubou'], ":epaule"=>$_POST['epaule'], ":cou"=>$_POST['cou'], ":manche"=>$_POST['manche'], ":taille"=>$_POST['taille'], ":taillemanche"=>$_POST['taillemanche'], ":poignet"=>$_POST['poignet'], ":longueurpantalon"=>$_POST['longueurpantalon'], ":taillecou"=>$_POST['taillecou'], ":tourfess"=>$_POST['tourfess'], ":cuisse"=>$_POST['cuisse'], ":bas"=>$_POST['bas'], ":poitrine"=>$_POST['poitrine'], ":hanche"=>$_POST['hanche'], ":pince"=>$_POST['pince'], ":blouse"=>$_POST['blouse'], ":longueurjupe"=>$_POST['longueurjupe'], ":longueurrobe"=>$_POST['longueurrobe'], ":id_mesure"=>$_POST['id_mesure']));
