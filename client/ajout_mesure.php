...
<div class="container-fluid">
    ...
    $reponse = $bdd->query("SELECT * FROM zen_client ORDER BY zen_client.id_client DESC LIMIT 1");
	...
	<div class="card shadow mb-4">
		...
		<div class="card-footer">
            <input type="submit" class="btn btn-primary" name="bt_mesure" value="Valider">
