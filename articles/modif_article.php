									...
									<div class="card lg-8">
										...
										<input type="number" hidden name="codep" value="<?php echo $id_article; ?>" class="form-control">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" style="text-transform: uppercase" name="modele"  value="<?php echo $modele; ?>" class="form-control">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="footer">
												...
												<button type="submit" class="btn btn-success" name="bt_update_article" >Enregistrer</button>
											</div> 
											</div>
